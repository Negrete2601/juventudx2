<?php	
	...
	user_login();
	$tramites = fill_tramites_estudiante($_SESSION['usuario']);
	$tr_tramites = fill_tr_tramites($tramites);
?>
...
<div class="page-content"> 
							...
							<div class="message-infobar clearfix" id="id-message-infobar">
								...
								<span style="display: inline-block;" class="grey bigger-140">Trámites registrados</span>
								 <div style="display: inline-block; float: right;">
									<a href="javascript:cambiarcont('view/tramites/nuevo.php');" class="btn btn-primary">
	...
	<div id="load_modal_fill_datos"></div>
	<div id="load_modal_fill_datos2"></div>
