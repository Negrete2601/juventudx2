...
//Se asignan los valores recibidos del formulario a las siguientes variables
...
$pdf->setTitle('Carta de aceptación');
...
<span style="font-size:10pt;font-weight:bold;">Asunto: </span><span style="font-size:10pt;">Carta de Aceptación</span><br>
...
ha sido aceptado para realizar sus <span style="font-weight:bold;">Prácticas
Profesionales</span> en la <span style="font-weight:bold;">Instancia Municipal de la Juventud</span>
, asignada al Programa de Apoyo
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Carta de aceptación.pdf', 'I');
